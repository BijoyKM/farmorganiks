...
2. The website allows customer to contact the business for placing order, booking farm trips or providing feedback.
...
5. To place order for Collection or book a farm trip or to provide a feedback to the business.
...
# 2. Scope
* Required Farm Organiks business information is given with the help of easy to navigate sections in terms to user experience.
...
* The Visit Farm section provides information of activities that can be done on the farm. It also has Gallery and farm video sections.
...
The colour theme is based on the Farm Organiks logo which is a green color: #003300. For the website background white color: #ffffff is used. For border of containers various green shades like #012e26 and rgb(22, 190, 140) are used. For container background color rgba(240, 127, 22, 0.493), rgba(153, 255, 153, 0.500) and rgba(208, 221, 159, 0.493) are used. For Social media icons Charcoal Grey color: #3a3a3a is used. The color scheme is used in accordance of the business to reflect the natural green associated with organic produce.
...
* The nav items on the right are reponsive on multiple media queries. For smaller screens 'Shop Produce', 'Visit Farms' and 'Contact Us' all comes below the 'FARM ORGANIKS' logo in a single line. They are also reduced in font size for very small screens.
...
*   It has an image of carrots and herbs resembling the theme of the business of organic produces. It also has a Welcome message for the new and old user customers informing about the moto of the business "Welcome to Farm Organiks. Harvesting Goodness". This is also the landing page or Home page. If the user clicks on 'FARM ORGANIKS' logo anytime, it will bring to this section.

![About Us Image](/assets/images/readmeimages/AboutUs.jpg "About Us Image")

*   Below the Hero image, there is About Us section introducing the customers about the Family owned business.
...
*   The color of the border for these Veggies/Fruits.Misc sections are different shades of green. This is similar to all other containers like Contact Us etc. to create a consistent green feel thorughout the website.
...
*   The Contact Us has a background image of beautiful watermelon wedges in accordance to the organic and natural theme of the website and the business.
*   It has two containers. First one is a Call to Action Form and other is a Location Map of the farm itself.
### Form can be used to:
    1. Place a Collection Order.
    2. Book a Farm Trip.
    3. Provide a Feedback.

*   Following details are mandatory for using the form:
    1. Name
    2. Email
    3. Choose a radio button stating the purpose of the form filled.
    4. Text box with column and rows to enter a brief description. For eg. if Collection order is placed, provide the names of produce or if Farm Trip booking is required, provide the date and time, with number of attendees.


*   The Form container has a border of different green shades similar to the other containers. The Form container is responsive as the screen size reduces the form container size also reflects accordingly. The Text box properties are responsive as well as the number of columns and rows reduces as the screen size reduces.

### Getting Here
*   The Location Map provides user the geo location of the farm and direction how to get there. The Location map container is responsive and its size reduces as the screen size reduces. It also alligns vertically under the Form when the screen size reduces.
...
*   [Code Institute](https://codeinstitute.net/ie/) classes and videos helped in most of the concepts especially in form buidling, UX etc in addition to everything else.
